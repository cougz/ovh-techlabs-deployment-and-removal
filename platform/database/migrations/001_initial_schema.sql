...
-- Description: Create initial database schema for TechLabs Automation
-- Created: 2025-07-07
...
CREATE TABLE attendees (
    ...
    status VARCHAR(50) DEFAULT 'pending' CHECK (status IN ('pending', 'deploying', 'active', 'failed', 'deleting', 'deleted')),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
